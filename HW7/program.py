...
#
# print_operation_table(lambda x, y: x * y)
# var2 # не смог убрать распечатку списка, надо доп изучение
# def print_operation_table(operation, num_rows=6, num_columns=6):
#     return [print(*print_rows(operation, i, num_columns)) for i in range(1, num_rows + 1)]
#
#
# def print_rows(f, i, num_columns):
#     return [print(f(k, i), end=' ') for k in range(1, num_columns + 1)]
#
#
# print_operation_table(lambda x, y: x * y)
